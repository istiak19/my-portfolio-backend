        ...
        hobbies: [
            {
                title: "Traveling",
                description:
                    "Exploring new places, meeting diverse people, and embracing cultures.",
            },
            {
                title: "Food Lover",
                description:
                    "Trying local cuisine and street food from different regions.",
            },
            {
                title: "Learning",
                description:
                    "Constantly upskilling myself with the latest tech trends and frameworks.",
            },
            {
                title: "Photography",
                description:
                    "Capturing moments during my travels and everyday life.",
            },
        ],
    };
};